            ...
            <div className="content container-fluid" >
                ...
                <div className="row">
                    ...
                    <div className="col-sm-7 col-7 text-right m-b-30">
                        <a href="#" data-name='Add Designation' onClick={this.showModal} className="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_designation"><i className="fa fa-plus" /> Add New Department</a>
                    </div>
                </div>
                <div className="row">
                                                ...
                                                <td className="text-right">
                                                    <div className="dropdown dropdown-action">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-right">
                                                            <a data-name="Edit Designation" onClick={this.showModal} className="dropdown-item" href="#" data-toggle="modal" data-target="#edit_designation"><i className="fas fa-pen m-r-5" />
                                                                Edit</a>
                                                            <a data-name="Delete Designation" onClick={this.showModal} className="dropdown-item" href="#" data-toggle="modal" data-target="#delete"><i className="far fa-trash-alt m-r-5" /> Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
let mapStateToProps = (state) => {
    return {
        designations: state.infomations.designations,
    }
}
