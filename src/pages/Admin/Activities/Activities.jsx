                                ...
                                <div className="activity-box">
                                    <ul className="activity-list">
                                        <li>
                                            ...
                                            <div className="activity-content">
                                                <div className="timeline-content">
                                                    <Link to="/admin/profile" className="name">Lesley Grauer</Link> added new task <a href="#">Hospital Administration</a>
                                        ...
                                        <li>
                                            ...
                                            <div className="activity-content">
                                                <div className="timeline-content">
                                                    <Link to="/admin/profile" className="name">Jeffery Lalor</Link> added <Link to="/admin/profile" className="name">Loren Gatlin</Link> and <Link to="/admin/profile" className="name">Tarah Shropshire</Link> to project <Link to="#">Patient appointment booking</Link>
                                        ...
                                        <li>
                                            ...
                                            <div className="activity-content">
                                                <div className="timeline-content">
                                                    <Link to="/admin/profile" className="name">Catherine Manseau</Link> completed task
                                        ...
                                        <li>
                                            ...
                                            <div className="activity-content">
                                                <div className="timeline-content">
                                                    <Link to="/admin/profile" className="name">Mike Litorus</Link> added new task <a href="#">Patient and Doctor video conferencing</a>
                                        ...
                                        <li>
                                            ...
                                            <div className="activity-content">
                                                <div className="timeline-content">
                                                    <Link to="/admin/profile" className="name">Jeffery Lalor</Link> added <Link to="/admin/profile" className="name">Jeffrey Warden</Link> and <Link to="/admin/profile" className="name">Bernardo Galaviz</Link> to the task of
