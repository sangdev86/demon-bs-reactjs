                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="card-box">
                            <h4 className="payslip-title">Payslip for the month of September 2017</h4>
                            <div className="row">
                                <div className="col-sm-6 m-b-20">
                                    <img src="../assets/img/logo.png" className="inv-logo" />
                            ...
                            <div className="row">
                                <div className="col-lg-12 m-b-20">
                                    <ul className="list-unstyled">
                                        <li>
                                            <h5 className="m-b-0"><strong>John Doe</strong></h5>
                                        </li>
