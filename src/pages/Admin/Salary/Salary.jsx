    ...
    render() {
        ...
        return (
            <div className="content container-fluid">
                ...
                <HeaderEmployees showModal={this.showModal} act="Salary" />
                <div className="row">
                                    ...
                                    {listUser && listUser.map((user, index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>{user.salary}</td>
                                                <td><Link className="btn btn-sm btn-primary" to="/admin/salary-view">Generate Slip</Link></td>
                                                <td className="text-right">
                                                    <div className="dropdown dropdown-action">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-right">
                                                            <a data-name="Edit Staff Salary" onClick={this.showModal} className="dropdown-item" href="#" data-toggle="modal" data-target="#edit_salary"><i className="fas fa-pen m-r-5" />
                                                                Edit</a>
                                                            <a data-name="Delete Staff Salary" onClick={this.showModal} className="dropdown-item" href="#" data-toggle="modal" data-target="#delete"><i className="far fa-trash-alt m-r-5" /> Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
